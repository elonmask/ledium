...
const TableLamp = () => {
  ...
  const goodsOfTableLamp = goodsWithImages.filter(good => good.name.includes('Настольная'));
            ...
            <div className="sidebar">
                <div className="sidebar-menu">
                    <ul className="sidebar-list">
                        ...
                        <li className="sidebar-item"><a href="spotlight" className="sidebar-link">Прожекторы</a></li>
                        ...
                        <li className="sidebar-item"><a href="#" className="sidebar-link sidebar-active">Настольные лампы</a></li>
                    </ul>
                </div>
            </div>
            <div className="catalog-content">
                <div className="catalog-goods"> 
                  {goodsOfTableLamp.map(good => (
                    <Link to="product">
                    <div className="card">
