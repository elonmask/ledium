...
const Tabs = ({ products }) => {
  ...
  const tabs = [
    ...
    },
    {
      id: 4,
      title: 'Замовлення',
      content: ['Мінімальне замовлення в Інтернет-магазині "LEDium" становить 200,00 грн. При замовленні від 200,00 до 1000,00 грн. послугу доставки сплачує клієнт.', 'При замовленні від 1000,00 грн. послуги доставки товару і повернення платежу безкоштовні.', 'Для зручності покупців, Інтернет-магазин "LEDium" приймає замовлення в режимі on-line цілодобово, без вихідних.', 'Замовлення обробляються до 10 хвилин з 8:00 до 17:00 в робочі дні.', 'Замовлення, що надходять в неробочий час (в тому числі у вихідні та святкові дні) обробляються в найближчий робочий день до 10:00.'],
    },
    {
      id: 5,
      title: 'Гарантії',
